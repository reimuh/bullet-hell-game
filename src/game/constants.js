...
// the width and height of the player square, in pixels

export const PLAYER_SPEED = 4;
// how many pixels the player moves per frame when a movement key is held

export const PLAYER_FIRE_INTERVAL_BASE = 250;
// the base milliseconds between automatic player shots, before any upgrades

export const PLAYER_FIRE_INTERVAL_MIN = 60;
// the fastest the player is ever allowed to fire, no matter how many "faster shooting" cards are picked

export const PLAYER_BULLET_SPEED = 7;
// how many pixels a player bullet travels upward per frame

export const PLAYER_BULLET_RADIUS_BASE = 3;
// the base radius used to draw and collide player bullets, before any "bigger bullets" upgrades

export const PLAYER_MAX_HEARTS = 3;
// how many hits the player can take before dying

export const PLAYER_INVULN_FRAMES = 90;
// how many frames the player is briefly invulnerable for after taking a hit, at 60fps this is 1.5 seconds
...
// how many pixels a normal enemy moves per frame while wandering

export const ENEMY_ZONE_BOTTOM = CANVAS_HEIGHT / 2;
// enemies are only allowed to roam in the top half of the canvas, this is that boundary's y value

export const ENEMY_BULLET_SPEED = 2.1;
// how many pixels a normal enemy's bullet travels per frame, slowed down from the original 3.5
...
// how many hits a normal enemy takes to die on wave 1

export const HP_INCREASE_PER_WAVE = 3;
// how many extra hit points each new wave adds to every normal enemy
...
// how much more experience each subsequent level requires, on top of the base
...
// how fast bullets travel in the boss's spinning ring pattern, slowed down from the original 2.2, kept slow so the ring is dodgeable

export const BOSS_AIMED_BULLET_SPEED = 2.8;
// how fast bullets travel in the boss's aimed-spread pattern, slowed down from the original 4.2, still faster than the ring bullets

export const BOSS_PATTERN_SWITCH_FRAMES = 240;
// how many frames the boss spends on one attack pattern before switching to the other, at 60fps this is 4 seconds



export const SLOW_DURATION_FRAMES = 90;
// how many frames a "slowed" enemy stays slowed after being hit, at 60fps this is 1.5 seconds

export const SLOW_STEP = 0.12;
// how much extra slow percentage each "slowing field" card adds

export const MAX_SLOW_PERCENT = 0.7;
// the maximum fraction an enemy's speed can ever be reduced by, so it never fully freezes
...
// each "faster shooting" card multiplies the fire interval by this, making it smaller/faster
